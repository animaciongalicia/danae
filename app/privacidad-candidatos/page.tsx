    ...
    <main className="flex-1 py-16 sm:py-20">
      <Container className="max-w-3xl">
        ...
        <p className="mt-5 leading-relaxed text-muted">
          ...
          personas que envían su candidatura a DANAE a través del formulario
          «Trabaja con Danae», conforme al Reglamento (UE) 2016/679 (RGPD) y a
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 leading-relaxed text-muted">
            ...
            selección de los servicios que gestiona DANAE, y para contactarte
